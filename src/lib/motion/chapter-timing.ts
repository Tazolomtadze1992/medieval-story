...
export const CHAPTER_TITLE_DELAY_S = 0.14;

/** Horizontal mask + opacity for the chapter title. */
export const CHAPTER_TITLE_REVEAL_DURATION_S = 0.9;
 ...
 */
export const CHAPTER_PARAGRAPH_AFTER_TITLE_START_S = 0.45;

/** Opacity-led chunk reveal duration (paragraph). */
export const CHAPTER_PARAGRAPH_CHUNK_DURATION_S = 0.42;

/** Delay between the start of each chunk’s reveal (stagger). */
export const CHAPTER_PARAGRAPH_CHUNK_STAGGER_S = 0.09;
